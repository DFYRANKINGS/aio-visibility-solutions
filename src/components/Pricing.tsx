...
const plans = [
  {
    ...
    originalPrice: "$997",
    period: "month",
    description: "Done-for-you AI visibility, billed monthly with the same scope as our annual plan.",
    features: [
      ...
      "Dedicated support — month-to-month flexibility, cancel anytime"
    ],
    popular: false,
    discount: "50% OFF",
