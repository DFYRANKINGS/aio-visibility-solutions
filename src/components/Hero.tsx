          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                To get listed in AI search (answer engines) across the web, you need to repurpose your information into machine-readable data (or structured data). It looks similar to HTML, but it's for Large Language Models/AI bots. We specialize in AI Optimization + Answer Engine Optimization <b>by transforming your information into datasets AI can understand, </b>and distributing it across platforms AI bots crawl to learn from. 
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
